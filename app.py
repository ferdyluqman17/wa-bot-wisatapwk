...
def webhook():
    ...
    elif incoming_msg == "Grama Tirta Jatiluhur":
    ...
    elif incoming_msg == "Desa Wisata Kampung Tajur":
    ...
    elif incoming_msg == "Gunung Parang":
    ...
    elif incoming_msg == "Makam Syech Ba'ing Yusuf":
    ...
    elif incoming_msg == "Makam Mama Sempur":
    ...
    elif incoming_msg == "Makam Eyang Pandita Tajur & Sekitarnya":
    ...
    elif incoming_msg == "Taman Surawisesa":
    ...
    elif incoming_msg == "Taman Pancawarna":
