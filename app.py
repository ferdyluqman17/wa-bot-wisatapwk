...
def webhook():
    ...
    if incoming_msg == "halo":
        ...
        religi_msg = ("Anda memilih Wisata Religi. Silakan pilih opsi berikutnya:\n1. Makam Syech Ba'ing Yusuf \n2. Makam Mama Sempur \n3. Makam Eyang Pandita Tajur & Sekitarnya \n4. Makam Eyang Gandasoli.")
    elif religi_msg == "Makam Syech Ba'ing Yusuf":
    ...
    elif religi_msg == "Makam Mama Sempur":
    ...
    elif religi_msg == "Makam Eyang Pandita Tajur & Sekitarnya":
    ...
    elif buatan_msg == "Taman Surawisesa":
    ...
    elif buatan_msg == "Taman Pancawarna":
